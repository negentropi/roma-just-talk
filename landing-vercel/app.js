const repoUrl = "https://github.com/negentropi/roma-just-talk";
const repoBranch = "without/no-adhoc-macos-tcc";
const latestReleaseUrl = `${repoUrl}/releases/latest`;
const releasesApi = "https://api.github.com/repos/negentropi/roma-just-talk/releases";
const latestReleaseApi = `${releasesApi}/latest`;
const releasesPageUrl = `${repoUrl}/releases`;
const rawBase = `https://raw.githubusercontent.com/negentropi/roma-just-talk/${repoBranch}/`;
