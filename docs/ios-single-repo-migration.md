...
- macOS audio-file retranscription uses `VoiceInkEngineError.audioFileNotFound` for missing stored audio and no longer keeps unused shell-only observable transcription state.
