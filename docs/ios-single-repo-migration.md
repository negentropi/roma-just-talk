...
- `iOS/VoiceInk-ios/LocalModelManager.swift` validates model-download HTTP responses through `VoiceInkWhisperModelDownloadResponsePolicy`; the iOS shell still owns URLSession task/progress state and user-facing download errors.
