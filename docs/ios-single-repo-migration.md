...
- stored audio-file path resolution, existing-file lookup, availability/missing-audio presentation, recordings directory, file URL construction, recording/import/retranscription filename policy, and record-level resolved/existing/delete/delete-and-clear helpers
