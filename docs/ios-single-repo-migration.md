...
- macOS audio-file retranscription uses `VoiceInkEngineError.audioFileNotFound` for missing stored audio and no longer keeps unused shell-only transcription error state.
