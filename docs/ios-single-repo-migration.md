...
- macOS cloud and streaming transcription adapters fetch custom-vocabulary terms through `CustomVocabularyService`, while `VoiceInkCustomVocabularyUse` owns normalization, provider/use-specific support, and term-limit code.
