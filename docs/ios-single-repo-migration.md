...
- vocabulary, word-replacement, backup dictionary insert, vocabulary backup record shape, word-replacement backup import planning, word-replacement edit planning, dictionary draft submit rules, dictionary alert titles, dictionary persistence failure copy, and dictionary settings presentation copy; platform shells still own macOS SwiftData dictionary storage and persistence execution
...
- iOS dictionary settings plus macOS vocabulary and word-replacement form labels/placeholders/help text consume `VoiceInkDictionarySettingsPresentation`; platform shells still own SwiftUI layout, button visibility, settings bindings, and SwiftData/UserDefaults persistence.
...
27. iOS dictionary settings and macOS dictionary form copy route through `VoiceInkDictionarySettingsPresentation`, with duplicate labels/placeholders/help text out of platform views.
