...
when a browser omits only its optional AX value snapshot, the required matching
selection snapshot plus strict role/bundle and focus/PID checks remain the
bounded validation.
