...
- performance-analysis aggregation for transcription/enhancement model averages, speed factor, and speed-factor display text; platform shells still own queries, filters, system information, and rendering
