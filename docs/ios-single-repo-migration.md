...
- AI-enhancement error vocabulary and user-facing descriptions; platform shells still own provider transport, provider-specific error mapping, retries, and logging
...
- macOS AI-enhancement failures throw `VoiceInkAIEnhancementError` from `VoiceInkCore`; macOS still owns LLMkit/Ollama/Local CLI error mapping, retry timing, and logging.
