...
- Added the last rolling-buffer quick-release claim strategy to diagnostics so packaged builds can show whether a release used ready preload, buffered audio snapshot, or missed the rolling path.
