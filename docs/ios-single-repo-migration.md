...
- vocabulary, word-replacement, backup dictionary insert, vocabulary backup record shape, word-replacement backup import planning, word-replacement edit planning, dictionary draft submit rules, dictionary alert titles, dictionary persistence failure copy, dictionary settings form/chrome presentation copy, and macOS dictionary quick-add presentation copy; platform shells still own macOS SwiftData dictionary storage and persistence execution
...
- iOS dictionary settings plus macOS dictionary form, section-card, hero, settings-panel, shortcut labels, and quick-add panel labels/placeholders/hints consume `VoiceInkDictionarySettingsPresentation`/`VoiceInkDictionaryQuickAddPresentation`; platform shells still own SwiftUI layout, button visibility, settings bindings, shortcut actions, panel sizing/focus, and SwiftData/UserDefaults persistence.
...
27. iOS dictionary settings plus macOS dictionary form/chrome and quick-add copy route through `VoiceInkDictionarySettingsPresentation`/`VoiceInkDictionaryQuickAddPresentation`, with duplicate labels/placeholders/help text out of platform views.
