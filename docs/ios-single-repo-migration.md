...
- vocabulary, word-replacement, backup dictionary insert, vocabulary backup record shape, word-replacement backup import planning, word-replacement edit planning, dictionary draft submit rules, dictionary alert titles, dictionary persistence failure copy, dictionary settings form/chrome presentation copy, macOS dictionary quick-add presentation copy, and word-replacement info/edit presentation copy; platform shells still own macOS SwiftData dictionary storage and persistence execution
...
- iOS dictionary settings plus macOS dictionary form, section-card, hero, settings-panel, shortcut labels, quick-add panel labels/placeholders/hints, word-replacement guidance, and edit-sheet labels consume `VoiceInkDictionarySettingsPresentation`/`VoiceInkDictionaryQuickAddPresentation`/`VoiceInkWordReplacementInfoPresentation`/`VoiceInkWordReplacementEditPresentation`; platform shells still own SwiftUI layout, button visibility, settings bindings, shortcut actions, panel sizing/focus, sheet presentation, and SwiftData/UserDefaults persistence.
...
27. iOS dictionary settings plus macOS dictionary form/chrome, quick-add, word-replacement guidance, and edit-sheet copy route through `VoiceInkDictionarySettingsPresentation`/`VoiceInkDictionaryQuickAddPresentation`/`VoiceInkWordReplacementInfoPresentation`/`VoiceInkWordReplacementEditPresentation`, with duplicate labels/placeholders/help text out of platform views.
