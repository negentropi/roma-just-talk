...
- AI-enhancement result shape for enhanced text, duration, selected model, prompt name, and request message metadata; platform shells still own provider execution and persistence targets
