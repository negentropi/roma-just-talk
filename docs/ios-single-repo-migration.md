...
- macOS cloud and streaming transcription adapters fetch normalized custom-vocabulary terms through `CustomVocabularyService`, so provider adapters no longer repeat SwiftData vocabulary fetch, normalization, or provider/use-specific term-limit code.
