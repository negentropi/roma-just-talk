...
opening word proves pre-trigger audio reached Chrome. The receipt also records
accuracy and key-up latency from Chrome's real speech service. The lane restores
and verifies the original input and output afterward.
