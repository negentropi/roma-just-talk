...
final class RollingBufferPreloadPolicyTests: XCTestCase {
    func testRollingAudioBufferAppendKeepsChunksWithinMaxBytes() {
    ...
    func testRollingAudioBufferAppendDropsWholeOldestChunksWhenOverflowCoversChunk() {
    ...
    func testRollingAudioBufferAppendPartiallyTrimsOldestChunkWhenOverflowIsSmallerThanChunk() {
    ...
    func testRollingAudioBufferUpdateMaxBytesTrimsAndClampsNegativeCapacity() {
    ...
    func testRollingAudioBufferAppendIgnoresEmptyChunksAndZeroCapacity() {
    ...
    func testRollingAudioBufferRemoveAllClearsChunksAndBytes() {
        var buffer = VoiceInkRollingAudioBuffer(maxBytes: 8)
        buffer.append(Data([0, 1]))
        buffer.append(Data([2, 3]))
