...
workflow. It uses a Mac mini M2 with Xcode 26.4.1, installs and mounts Apple's Metal
toolchain when needed on the headless runner, runs the shared core checks, then
