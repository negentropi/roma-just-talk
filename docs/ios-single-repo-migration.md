...
- vocabulary, word-replacement, backup dictionary insert, vocabulary backup record shape, word-replacement backup import planning, word-replacement edit planning, dictionary draft submit rules, dictionary alert titles, dictionary persistence failure copy, and dictionary settings form/chrome presentation copy; platform shells still own macOS SwiftData dictionary storage and persistence execution
...
- iOS dictionary settings plus macOS dictionary form, section-card, hero, settings-panel, and shortcut labels consume `VoiceInkDictionarySettingsPresentation`; platform shells still own SwiftUI layout, button visibility, settings bindings, shortcut actions, and SwiftData/UserDefaults persistence.
...
27. iOS dictionary settings plus macOS dictionary form/chrome copy route through `VoiceInkDictionarySettingsPresentation`, with duplicate labels/placeholders/help text out of platform views.
